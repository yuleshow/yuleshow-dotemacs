 ...
 (defun my-han-kai ()
       (interactive)
       (set-fontset-font (frame-parameter nil 'font) 'han (font-spec :family "TW-Kai")))
...
(defun my-han-SentyWen () 
   (interactive) 
   (set-fontset-font (frame-parameter nil 'font) 'han (font-spec :family "SentyWen Regular")))
)
